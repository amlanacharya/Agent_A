...
|| 9: Cockpit Frontend | 🚧 In Progress (2026-06-18) | CB1 done (`f18edc4`): plan rewrite appended to workspace plan; Hard Rules extended with frontend never-commit paths; Phase 8 'Future external integrations' updated to point at Phase 9. 11 CBs remaining: CB2 scaffold + DESIGN.md tokens, CB3 API client + openapi-typescript codegen + contract test, CB4 routing + global layout + GET /runs, CB5 Mission Control, CB6 Data Health, CB7 EDA Explorer, CB8 Feature Factory, CB9 Model Arena, CB10 Forecast Review, CB11 Replenishment Board + Learning Journal, CB12 MLOps Monitor + plot frame + e2e + delete prototype/. |
